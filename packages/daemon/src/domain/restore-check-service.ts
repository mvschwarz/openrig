...
const CLAUDE_SESSION_START_COMPACT_COMMAND = "~/.openrig/shared-docs/control-plane/services/claude-hooks/bin/session-start-compact-context.sh";
const CLAUDE_USER_PROMPT_SUBMIT_COMMAND = "~/.openrig/shared-docs/control-plane/services/claude-hooks/bin/userpromptsubmit-queue-attention.sh";
const CLAUDE_HOOK_FRAGMENT_PATH = "~/.openrig/shared-docs/control-plane/services/claude-hooks/config/settings.fragment.json";
