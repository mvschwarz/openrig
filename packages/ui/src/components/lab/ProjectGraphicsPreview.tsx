    ...
    <article className={cn("border border-outline-variant bg-surface-lowest/60 backdrop-blur-sm hard-shadow", dense ? "p-3" : "p-4")}>
      <div className="flex items-start justify-between gap-3">
        <div className="space-y-2">
          ...
          <h3 className="font-mono text-sm text-on-surface">Review demo-seed triage proof packet</h3>
        </div>
    ...
    <div className="paper-grid min-h-full p-8">
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <section className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          <VellumCard as="section" className="bg-surface-lowest/65 backdrop-blur-sm" header="EVENT BADGE VOCABULARY">
          ...
          <VellumCard as="section" className="bg-surface-lowest/65 backdrop-blur-sm" header="SUPPORTING CHIPS">
            <div className="space-y-4 p-4">
              <div>
                <div className="mb-2 font-mono text-[9px] uppercase tracking-[0.14em] text-on-surface-variant">Tags</div>
                <div className="flex flex-wrap gap-1.5">
              ...
              <div>
                <div className="mb-2 font-mono text-[9px] uppercase tracking-[0.14em] text-on-surface-variant">Scope</div>
                <div className="flex flex-wrap gap-1.5">
