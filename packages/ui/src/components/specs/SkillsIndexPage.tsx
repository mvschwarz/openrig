  ...
  return (
    ...
    >
      ...
      {isLoading && sorted.length === 0 ? (
        ...
        >
          <p className="font-bold uppercase tracking-wide text-on-surface">No skills visible</p>
          <p className="mt-2">
            Skills live under <code className="font-mono text-on-surface">.openrig/skills/</code> in your
