...
function settingsResponse(overrides: Record<string, { value: unknown; source: string; defaultValue: unknown }> = {}) {
  const baseline = {
    ...
    "workspace.projects_root": { value: "/tmp/ws/projects", source: "default", defaultValue: "/tmp/ws/projects" },
    "workspace.catalog_path": { value: "/tmp/ws/workspace.yaml", source: "default", defaultValue: "/tmp/ws/workspace.yaml" },
